...
public class HornetQOperationSelector extends BaseOperationSelector<HornetQBindingData> {
     ...
     */
    public HornetQOperationSelector(OperationSelectorModel model) {
        super(model);
    }

    @Override
    protected Document extractDomDocument(HornetQBindingData content) throws Exception {
    ...
    @Override
    protected String extractString(HornetQBindingData content) throws Exception {
        return new String(HornetQUtil.readBytes(content.getClientMessage()));
    }

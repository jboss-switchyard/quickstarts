...
public class ServiceTransformers {
    ...
    private static String SOAP_RESPONSE_TEMPLATE = "<imageResponse xmlns=\"urn:switchyard-quickstart:soap-mtom:1.0\">"
        + "<xop:Include xmlns:xop=\"http://www.w3.org/2004/08/xop/include\" href=\"cid:%s\"/>" + "</imageResponse>";

    private static String SOAP_EXTERNAL_REQUEST_TEMPLATE = "<ns2:image xmlns:ns2=\"urn:switchyard-quickstart:soap-mtom-external:1.0\">"
        + "<xop:Include xmlns:xop=\"http://www.w3.org/2004/08/xop/include\" href=\"cid:%s\"/>" + "</ns2:image>";

    private static String SOAP_EXTERNAL_RESPONSE_TEMPLATE = "<ns2:imageResponse xmlns:ns2=\"urn:switchyard-quickstart:soap-mtom-external:1.0\">"
        + "<xop:Include xmlns:xop=\"http://www.w3.org/2004/08/xop/include\" href=\"cid:%s\"/>" + "</ns2:imageResponse>";

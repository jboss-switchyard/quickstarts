...
public class Transformers {
     ...
     */
    @Transformer(from = "{urn:switchyard-quickstart:bean-service:1.0}submitOrder")
     ...
     */
    @Transformer(to = "{urn:switchyard-quickstart:bean-service:1.0}submitOrderResponse")
    public Element transform(OrderAck orderAck) {
        StringBuffer ackXml = new StringBuffer().append("<orders:submitOrderResponse xmlns:orders=\"urn:switchyard-quickstart:bean-service:1.0\">")
            .append("<orderAck>")

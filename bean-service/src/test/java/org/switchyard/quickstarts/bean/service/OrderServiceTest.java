...
public class OrderServiceTest {
    ...
    public void testOrderAccepted() throws Exception {
        Order testOrder = new Order().setOrderId("ORDER01").setItemId("BUTTER").setQuantity(100);

        OrderAck testAck = submitOrder.sendInOut(testOrder).getContent(OrderAck.class);

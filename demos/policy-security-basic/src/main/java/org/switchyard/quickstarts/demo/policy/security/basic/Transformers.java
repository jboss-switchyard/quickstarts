...
public class Transformers {
    ...
    public Element transformToElement(WorkAck workAck) {
        StringBuilder ackXml = new StringBuilder().append("<policy-security-basic:doWorkResponse xmlns:policy-security-basic=\"urn:switchyard-quickstart-demo:policy-security-basic:0.1.0\">")
            .append("<workAck>")

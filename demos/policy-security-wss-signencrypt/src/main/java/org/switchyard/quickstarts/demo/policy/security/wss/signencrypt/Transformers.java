...
public class Transformers {
    ...
    @Transformer(from = "{urn:switchyard-quickstart-demo:policy-security-wss-signencrypt:0.1.0}doWork")
    ...
    public Element transformToElement(WorkAck workAck) {
        StringBuilder ackXml = new StringBuilder().append("<policy-security-wss-signencrypt:doWorkResponse xmlns:policy-security-wss-signencrypt=\"urn:switchyard-quickstart-demo:policy-security-wss-signencrypt:0.1.0\">")
            .append("<workAck>")

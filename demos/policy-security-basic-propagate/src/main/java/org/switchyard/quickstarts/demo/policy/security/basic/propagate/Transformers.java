...
public class Transformers {
    ...
    public Element transformToElement(WorkAck workAck) {
        StringBuilder ackXml = new StringBuilder().append("<policy-security-basic-propagate:doWorkResponse xmlns:policy-security-basic-propagate=\"urn:switchyard-quickstart-demo:policy-security-basic-propagate:0.1.0\">")
            .append("<workAck>")

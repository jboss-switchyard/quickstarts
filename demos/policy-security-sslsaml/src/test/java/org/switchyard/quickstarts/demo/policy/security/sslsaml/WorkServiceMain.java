...
public final class WorkServiceMain {
    ...
    private static void invokeWorkService(String scheme, int port, Element assertion) throws Exception {
        ...
        http.initialize();
        try {
            String endpoint = String.format("%s://localhost:%s/policy-security-sslsaml/WorkService", scheme, port);
    ...
    private static Element getAssertion() throws Exception {
        ...
        //Element assertion = client.issueTokenForEndpoint("urn:switchyard-quickstart-demo:policy-security-sslsaml:0.1.0");

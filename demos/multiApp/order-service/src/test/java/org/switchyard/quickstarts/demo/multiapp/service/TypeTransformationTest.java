...
public class TypeTransformationTest {
    ...
    public void testTransformXMLtoJava() throws Exception {
        ...
        OrderAck orderAck = submitOrder.inputType(QName.valueOf("{urn:switchyard-quickstart-demo:multiapp:1.0}submitOrder"))
    ...
    public void testTransformJavaToXML() throws Exception {
        ...
        Element result = submitOrder.expectedOutputType(QName.valueOf("{urn:switchyard-quickstart-demo:multiapp:1.0}submitOrderResponse"))
            .sendInOut(testOrder)

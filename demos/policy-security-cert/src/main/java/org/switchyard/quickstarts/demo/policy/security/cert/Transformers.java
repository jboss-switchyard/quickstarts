...
public class Transformers {
    ...
    public Element transformToElement(WorkAck workAck) {
        StringBuilder ackXml = new StringBuilder().append("<policy-security-cert:doWorkResponse xmlns:policy-security-cert=\"urn:switchyard-quickstart-demo:policy-security-cert:0.1.0\">")
            .append("<workAck>")

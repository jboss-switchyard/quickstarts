 ...
 */
public enum ValidateNamespace implements Namespace {
    ...
    /**
     * Constructs a new ValidateNamespace with the specified version.
     * @param version the specified version, or null to discover the default
     */
    ValidateNamespace(String version) {
    ...
    /**
     * Gets the ValidateNamespace for the specified uri, or null if no matching uris are found.
     * @param uri the uri
     * @return the ValidateNamespace
     */
    public static ValidateNamespace fromUri(String uri) {
    ...
    private static final class Util extends Namespace.Util {
        ...
        private Util(String version) {
            super(DESCRIPTOR, "urn:switchyard-config:validate", version);
        }
    }

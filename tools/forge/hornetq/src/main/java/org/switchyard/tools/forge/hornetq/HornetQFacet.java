...
/**
 * Forge facet for HornetQ binding functionality.
 */
@Alias("switchyard.hornetq")
@RequiresFacet({ DependencyFacet.class, PackagingFacet.class, SwitchYardFacet.class, CommonFacet.class })
@RequiresPackagingType(PackagingType.JAR)
public class HornetQFacet extends AbstractFacet {
    
    private static final String HORNETQ_MAVEN_ID = 
        "org.switchyard.components:switchyard-component-hornetq";

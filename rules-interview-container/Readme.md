...
3. Install the feature for the Rules Interview Container quickstart :

karaf@root> features:install switchyard-quickstart-rules-interview-container
...
karaf@root> features:uninstall switchyard-quickstart-rules-interview-container

...
/**
 * The common "binding" model which supports OperationSelector.
 */
public interface BindingModel extends org.switchyard.config.model.composite.BindingModel {
     ...
     * @param model operation selector model
     * @return this BindingModel for chaining
     */

...
@SwitchYardTestCaseConfig(mixins = { CDIMixIn.class, HTTPMixIn.class }, scanners = {
        BeanSwitchYardScanner.class,
        TransformSwitchYardScanner.class }, config = SwitchYardTestCaseConfig.SWITCHYARD_XML)

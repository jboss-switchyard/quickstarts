 ...
 */
public class V1CamelSqlModelMarshaller extends V1BaseCamelMarshaller {

    private static final String BINDING_SQL = BindingModel.BINDING + '.' + V1CamelSqlBindingModel.SQL;
    ...
    public Model read(Configuration config) {
        ...
        if (BINDING_SQL.equals(name)) {
            return new V1CamelSqlBindingModel(config, desc);
        }

...
public class V1NtlmAuthModel extends V1BasicAuthModel implements NtlmAuthModel {
    ...
    private SOAPNameValueModel _domain;
    ...
    public V1NtlmAuthModel(String namespace) {
        super(namespace, SOAPName.ntlm.name());
    }
    ...
    public String getDomain() {
        if (_domain == null) {
            _domain = getNameValue(SOAPName.domain);
        }
    ...
    public NtlmAuthModel setDomain(String domain) {
        _domain = setNameValue(_domain, SOAPName.domain, domain);
        return this;
    }
}

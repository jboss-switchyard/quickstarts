 ...
 */
public enum ClojureNamespace implements Namespace {
    ...
    /**
     * Constructs a new ClojureNamespace with the specified version.
     * @param version the specified version, or null to discover the default
     */
    ClojureNamespace(String version) {
    ...
    /**
     * Gets the ClojureNamespace for the specified uri, or null if no matching uris are found.
     * @param uri the uri
     * @return the ClojureNamespace
     */
    public static ClojureNamespace fromUri(String uri) {
        return Util.fromUri(ClojureNamespace.class, uri);
    }
    ...
    private static final class Util extends Namespace.Util {
        ...
        private static final Descriptor DESCRIPTOR = new Descriptor(ClojureNamespace.class);
        private Util(String version) {
            super(DESCRIPTOR, "urn:switchyard-component-clojure:config", version);
        }
    }

...
public class GreetingServiceBean implements org.switchyard.quickstarts.hornetq.GreetingService {

    @Inject @Reference
    StoreResponseService _storeService;
    
    @Override
    public final void greet(final String name) {
        _storeService.process("Hello there " + name + " :-) ");
    }
}

...
public class CreateFlightTripRequest {
    ...
    public void create(Exchange exchange) throws Exception {
        ...
        // Get flight connection info, flight customer info and passenger info bean objects from exchange property.
        FlightConnectionInfo flightConnectionInfo = exchange.getProperty(AggregateFlightBookingStrategy.FLIGHT_CONNECTION_INFO, FlightConnectionInfo.class);
        FlightCustomerInfo flightCustomerInfo = exchange.getProperty(AggregateFlightBookingStrategy.FLIGHT_CUSTOMER_INFO, FlightCustomerInfo.class);
        PassengerInfo passengerInfo = exchange.getProperty(AggregateFlightBookingStrategy.PASSENGER_INFO, PassengerInfo.class);

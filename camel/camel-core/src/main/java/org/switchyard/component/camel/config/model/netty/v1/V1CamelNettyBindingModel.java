...
import org.switchyard.component.camel.config.model.netty.CamelNettyBindingModel;
...
public abstract class V1CamelNettyBindingModel extends V1BaseCamelBindingModel
     ...
     */
    public V1CamelNettyBindingModel() {
        super(NETTY);
     ...
     */
    public V1CamelNettyBindingModel(Configuration config, Descriptor desc) {
        super(config, desc);
    }

    protected V1CamelNettyBindingModel(String name) {
        super(name);
    }

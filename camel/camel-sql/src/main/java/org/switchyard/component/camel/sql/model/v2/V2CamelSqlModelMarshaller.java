...
public class V2CamelSqlModelMarshaller extends V1BaseCamelMarshaller {
    ...
    private static final String BINDING_SQL = BindingModel.BINDING + '.' + V2CamelSqlBindingModel.SQL;
     ...
     */
    public V2CamelSqlModelMarshaller(Descriptor desc) {
        super(desc);
    }
    ...
    public Model read(Configuration config) {
        ...
        if (BINDING_SQL.equals(name)) {
            return new V2CamelSqlBindingModel(config, desc);
        }

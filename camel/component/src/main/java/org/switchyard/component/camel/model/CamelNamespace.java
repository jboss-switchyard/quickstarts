...
/**
 * A Camel config model namespace.
 *
 * @author David Ward &lt;<a href="mailto:dward@jboss.org">dward@jboss.org</a>&gt; &copy; 2013 Red Hat Inc.
 */
public enum CamelNamespace implements Namespace {
    ...
    /**
     * Gets the CamelNamespace for the specified uri, or null if no matching uris are found.
     * @param uri the uri
     * @return the CamelNamespace
     */
    public static CamelNamespace fromUri(String uri) {
        return Util.fromUri(CamelNamespace.class, uri);
    }
    ...
    private static final class Util extends Namespace.Util {
        ...
        private static final Descriptor DESCRIPTOR = new Descriptor(CamelNamespace.class);
        private Util(String version) {
            super(DESCRIPTOR, "urn:switchyard-component-camel:config", version);
        }
    }

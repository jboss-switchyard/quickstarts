...
public class ObjectFactory {
    ...
    private final static QName PERSON_QNAME = new QName("urn:switchyard-quickstart:jca-inflow-hornetq:0.1.0", "person");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: quickstart.switchyard.jca_inflow_hornetq._1.
     * 
     */

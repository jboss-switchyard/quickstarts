...
public class Transformers {
    ...
    @Transformer(from = "{urn:switchyard-quickstart-demo:security-propagation-basic:0.1.0}doWork")
    ...
    @Transformer(to = "{urn:switchyard-quickstart-demo:security-propagation-basic:0.1.0}doWorkResponse")
    public Element transformToElement(WorkAck workAck) {
        StringBuilder ackXml =
            new StringBuilder()
                .append("<security-propagation-basic:doWorkResponse xmlns:security-propagation-basic=\"urn:switchyard-quickstart-demo:security-propagation-basic:0.1.0\">")
                .append("<workAck>")
                .append("<command>" + workAck.getCommand() + "</command>")
                .append("<received>" + workAck.isReceived() + "</received>")
                .append("</workAck>")
                .append("</security-propagation-basic:doWorkResponse>");

...
public class WebServiceTest {
    ...
    public void invokeOrderWebService() throws Exception {
        httpMixIn.postResourceAndTestXML("http://localhost:18001/quickstart-validate-xml/OrderService",
    ...
    public void invokeOrderWebServiceValidationFail() throws Exception {
        String response = httpMixIn.postResource("http://localhost:18001/quickstart-validate-xml/OrderService",
            "/xml/soap-request-with-invalid-element.xml");

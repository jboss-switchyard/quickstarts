 ...
 */
public enum RESTEasyNamespace implements Namespace {
    ...
    /**
     * Constructs a new RESTEasyNamespace with the specified version.
     * @param version the specified version, or null to discover the default
     */
    RESTEasyNamespace(String version) {
    ...
    /**
     * Gets the RESTEasyNamespace for the specified uri, or null if no matching uris are found.
     * @param uri the uri
     * @return the RESTEasyNamespace
     */
    public static RESTEasyNamespace fromUri(String uri) {
    ...
    private static final class Util extends Namespace.Util {
        ...
        private Util(String version) {
            super(DESCRIPTOR, "urn:switchyard-component-resteasy:config", version);
        }
    }

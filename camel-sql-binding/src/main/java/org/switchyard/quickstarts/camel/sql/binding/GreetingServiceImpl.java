...
public class GreetingServiceImpl implements GreetingService {
    ...
    private final static String[] NAMES = { "Keith", "David", "Brian", "Rob", "Tomo", "Lukasz", "Magesh", "Tom" };
    ...
    public void consume(Greeting[] greetings) {
        for (Greeting greeting : greetings) {
            System.out.println("Consumed [id: " + greeting.getId() + "] from " + greeting.getSender() + " to "

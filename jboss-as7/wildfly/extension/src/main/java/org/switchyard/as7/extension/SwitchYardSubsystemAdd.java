...
//import org.switchyard.as7.extension.services.SwitchYardRegistryService;
...
public final class SwitchYardSubsystemAdd extends AbstractBoottimeAddStepHandler {
    ...
    protected void performBoottime(OperationContext context, ModelNode operation, ModelNode model, ServiceVerificationHandler verificationHandler, List<ServiceController<?>> newControllers) {
        ...
        /*final SwitchYardRegistryService registryService = new SwitchYardRegistryService();
        final ServiceBuilder<Map<String, String>> registryServiceBuilder = context.getServiceTarget().addService(SwitchYardRegistryService.SERVICE_NAME, registryService);
        registryService.setRegistry(context.getServiceRegistry(false));
        registryServiceBuilder.setInitialMode(Mode.ACTIVE);
        newControllers.add(registryServiceBuilder.install());*/

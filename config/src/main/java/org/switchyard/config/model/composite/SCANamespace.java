...
public enum SCANamespace implements Namespace {
    ...
    /**
     * Constructs a new SCANamespace with the specified version.
     * @param version the specified version, or null to discover the default
     */
    SCANamespace(String version) {
    ...
    /**
     * Gets the SCANamespace for the specified uri, or null if no matching uris are found.
     * @param uri the uri
     * @return the SCANamespace
     */
    public static SCANamespace fromUri(String uri) {
    ...
    private static final class Util extends Namespace.Util {
        ...
        private Util(String version) {
            super(DESCRIPTOR, "http://docs.oasis-open.org/ns/opencsa/sca", version);
        }
    }

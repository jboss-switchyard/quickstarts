...
public class ServiceTransformers {
    ...
    private static String SOAP_TEMPLATE = "<ns2:sayHello xmlns:ns2=\"urn:switchyard-quickstart:soap-binding-rpc:1.0\">"
        + "    <toWhom>%s</toWhom>" + "    <language>%s</language>" + "</ns2:sayHello>";

    private static String SOAP_RESPONSE_TEMPLATE = "<ns2:sayHelloResponse xmlns:ns2=\"urn:switchyard-quickstart:soap-binding-rpc:1.0\">"
        + "    <return>%s</return>" + "</ns2:sayHelloResponse>";

    private static String SOAP_TEMPLATE_EXTERNAL = "<ns2:sayHello xmlns:ns2=\"urn:switchyard-quickstart:external:1.0\">"
        + "    <toWhom>%s</toWhom>" + "    <language>%s</language>" + "    <day>%s</day>" + "</ns2:sayHello>";

    private static String SOAP_RESPONSE_TEMPLATE_EXTERNAL = "<ns2:sayHelloResponse xmlns:ns2=\"urn:switchyard-quickstart:external:1.0\">"
        + "    <return>%s</return>" + "</ns2:sayHelloResponse>";

...
/**
 * SwitchYard Component Reference Metrics
 */
@JsonIgnoreProperties(ignoreUnknown=true)
public class ComponentReferenceMetrics extends Metrics implements NamedMetric {
    private final String name;
    
    @JsonCreator
    public ComponentReferenceMetrics(@JsonProperty("name") String name,

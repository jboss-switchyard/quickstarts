...
/**
 * SwitchYard Reference Binding Discovery Component
 */
public class ReferenceBindingDiscoveryComponent implements ResourceDiscoveryComponent<ReferenceResourceComponent> {
    /**
     * The logger instance.
     */
    private static Log LOG = LogFactory.getLog(ReferenceBindingDiscoveryComponent.class);

 ...
 * Reset Metrics
 */
public class StartGateway extends Operation {
    public StartGateway(final String applicationName, final String compositeName, final String gatewayName, final String type) {
        super(DMR_START_GATEWAY, ADDRESS_SWITCHYARD);

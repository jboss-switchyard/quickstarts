...
/**
 * SwitchYard Gateway(Binding) Metrics
 */
@JsonIgnoreProperties(ignoreUnknown=true)
public class GatewayMetrics extends Metrics implements NamedMetric {
    private final String name;
    
    @JsonCreator
    public GatewayMetrics(@JsonProperty("name") String name,

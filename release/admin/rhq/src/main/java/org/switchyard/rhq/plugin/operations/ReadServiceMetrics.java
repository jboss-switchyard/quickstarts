 ...
 */
public class ReadServiceMetrics extends Operation {
    public ReadServiceMetrics() {
        this("*");
    }

    public ReadServiceMetrics(final String service) {
        super(DMR_SHOW_METRICS, ADDRESS_SWITCHYARD);
        addAdditionalProperty(PARAM_TYPE, "service");
        addAdditionalProperty(PARAM_SERVICE_NAME, service);
    }
}

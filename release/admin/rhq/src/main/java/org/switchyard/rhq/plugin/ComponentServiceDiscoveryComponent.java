...
/**
 * SwitchYard Component Service Discovery Component
 */
public class ComponentServiceDiscoveryComponent implements ResourceDiscoveryComponent<ApplicationResourceComponent> {
    /**
     * The logger instance.
     */
    private static Log LOG = LogFactory.getLog(ComponentServiceDiscoveryComponent.class);

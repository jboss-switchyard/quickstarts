 ...
 * Reset Metrics
 */
public class ResetServiceMetrics extends Operation {
    public ResetServiceMetrics(final String applicationName, final String serviceName) {
        super(DMR_RESET_METRICS, ADDRESS_SWITCHYARD);
        addAdditionalProperty(PARAM_APPLICATION_NAME, applicationName);
        addAdditionalProperty(PARAM_NAME, serviceName);
        addAdditionalProperty(PARAM_TYPE, "service");
    }
}

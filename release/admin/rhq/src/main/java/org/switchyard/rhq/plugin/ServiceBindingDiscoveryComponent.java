...
/**
 * SwitchYard Service Binding Discovery Component
 */
public class ServiceBindingDiscoveryComponent implements ResourceDiscoveryComponent<ServiceResourceComponent> {
    /**
     * The logger instance.
     */
    private static Log LOG = LogFactory.getLog(ServiceBindingDiscoveryComponent.class);

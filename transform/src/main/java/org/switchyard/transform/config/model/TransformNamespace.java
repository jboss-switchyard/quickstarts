 ...
 */
public enum TransformNamespace implements Namespace {
    ...
    /**
     * Constructs a new TransformNamespace with the specified version.
     * @param version the specified version, or null to discover the default
     */
    TransformNamespace(String version) {
    ...
    /**
     * Gets the TransformNamespace for the specified uri, or null if no matching uris are found.
     * @param uri the uri
     * @return the TransformNamespace
     */
    public static TransformNamespace fromUri(String uri) {
    ...
    private static final class Util extends Namespace.Util {
        ...
        private Util(String version) {
            super(DESCRIPTOR, "urn:switchyard-config:transform", version);
        }
    }

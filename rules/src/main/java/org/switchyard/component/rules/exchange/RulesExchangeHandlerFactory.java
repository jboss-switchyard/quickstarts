...
/**
 * Creates RulesExchangeHandlers via the JDK ServiceLoader mechanism.
 *
...
public abstract class RulesExchangeHandlerFactory {
    ...
    /**
     * Creates a new RulesExchangeHandler.
     * @return the RulesExchangeHandler
     */
    public abstract RulesExchangeHandler newRulesExchangeHandler();

    /**
     * Returns the singleton instance of the RulesExchangeHandlerFactory.
